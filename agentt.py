...
async def entrypoint(ctx: agents.JobContext):
    ...
    await session.generate_reply(
        instructions= "Begin by warmly greeting the customer as a professional Vuori sales assistant. "
        "Keep your tone friendly and concise. Do not proceed to any other steps yet. "
        "Wait for the customer to respond before continuing.", "Hi! Chloe - AI Agent here from Vuori Clothing.com. May I have a moment of your time? We've reduced the price on the product you were checking out.",
